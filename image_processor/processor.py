...
from components.detection import ImageDetection
from components.detection import TextDetection
import numpy as np
from components.app_logger.logger import logging
from components.app_exception import AppException
import sys
from components.html_process import CreateAlignment
from components.html_process import TextAlignment
from components.html_process import CreateHTML

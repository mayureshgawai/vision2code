...
from components.mmocr_ocr.mmocr.models.builder import (DETECTORS, build_convertor, build_decoder,
                                  build_encoder, build_loss)
from components.mmocr_ocr.mmocr.models.textrecog.recognizer.base import BaseRecognizer

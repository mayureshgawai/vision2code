...
from components.mmocr_ocr.mmocr.models.builder import HEADS, build_loss
from components.mmocr_ocr.mmocr.models.textdet.modules import GCN, LocalGraphs, ProposalLocalGraphs
from components.mmocr_ocr.mmocr.utils import check_argument

...
from components.mmocr_ocr.mmocr.models.builder import ENCODERS
from components.mmocr_ocr.mmocr.models.textrecog.layers import (Adaptive2DPositionalEncoding,
                                           SatrnEncoderLayer)

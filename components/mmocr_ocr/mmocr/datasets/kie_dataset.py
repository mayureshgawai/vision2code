...
from components.mmocr_ocr.mmocr.core import compute_f1_score
from components.mmocr_ocr.mmocr.datasets.base_dataset import BaseDataset
from components.mmocr_ocr.mmocr.datasets.pipelines import sort_vertex8
from components.mmocr_ocr.mmocr.utils import is_type_list, list_from_file

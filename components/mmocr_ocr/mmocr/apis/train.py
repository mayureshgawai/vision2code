...
from components.mmocr_ocr.mmocr import digit_version
from components.mmocr_ocr.mmocr.apis.utils import (disable_text_recog_aug_test,
                              replace_image_to_tensor)
from components.mmocr_ocr.mmocr.utils import get_root_logger
